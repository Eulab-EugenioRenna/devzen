        ...
        <Dialog open={true} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-3xl h-[80vh] flex flex-col p-6">
                ...
                <Tabs defaultValue="editor" className="flex-grow flex flex-col min-h-0">
                    ...
                    <TabsContent value="editor" className="flex-grow flex flex-col min-h-0">
                       <RichTextEditor
                         content={content}
                         onChange={setContent}
                       />
                    </TabsContent>
                    <TabsContent value="preview" className="flex-grow relative min-h-0">
                        <ScrollArea className="absolute inset-0 h-full w-full border rounded-b-md">
                            <div className='p-4'>
